...
- [ ] 1. Adicionar imports dos reporters ao comando validate
...
- [ ] 2. Implementar função `selectReporter` no CLI
...
- [ ] 3. Integrar chamada ao reporter no action do comando validate
...
- [ ] 4. Remover output JSON duplicado
...
- [ ] 7. Escrever property-based tests para as propriedades de correção
